<div class="row">
    ...
    <div class="col-md-12 col-sm-12 mt-2">
        ...
        <input onkeyup="findInfoPeoples(this.value)" type="text" class="form-control" id="people" name="people" placeholder="Escribe cualquier campo de la persona previamente registrada" required>
    </div>
