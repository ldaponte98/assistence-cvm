...
@section('content')
	<form id="form" class="login100-form validate-form" method="POST" action="{{ route('event/autoregister/save', $event->id) }}">
		...
		@if ($event->type == App\Shared\EventType::CONECTIONS_GROUP)
			<div id="box-group">
				...
				<div class="wrap-input100 validate-input m-b-23">
					<input required class="input100" type="number" id="phone-validation">
					<span class="focus-input100" data-symbol="&#xf206;"></span>
				</div>
				<div class="container-login100-form-btn">
					<div class="wrap-login100-form-btn">
						<div class="login100-form-bgbtn"></div>
						<button type="button" onclick="validatePhoneExist()" class="login100-form-btn btn-loading">
							Continuar
						</button>
		...
		<div id="box-new" @if ($event->type == App\Shared\EventType::CONECTIONS_GROUP) class="hide" @endif>
			<span class="login100-form-title p-b-10">
				Ingresa los datos
			</span>
